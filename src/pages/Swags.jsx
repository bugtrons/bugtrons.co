...
function Swags() {
  return (
    <div>
      <Navbar />
      <div className="swags">
        <header className="heading">Swags</header>
        <div className="subtitle">Here are your exciting prizes</div>
        ...
        <div className="small">
          <strong>*Disclaimer</strong>: The colour and design of the prizes may
          vary. Participation certificates would be granted to the top 20
          performers
        </div>
      </div>
      <Footer />
